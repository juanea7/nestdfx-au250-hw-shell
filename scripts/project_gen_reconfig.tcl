...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_a3ctrl_M00_AXI [get_bd_intf_pins axi_ctrl/M00_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  ...
  connect_bd_net -net axi_traffic_gen_0_irq_out  [get_bd_pins axi_traffic_gen_0/irq_out] \
  ...
  assign_bd_address -offset 0x00000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces axi_traffic_gen_0/Data] [get_bd_addr_segs M00_AXI_0/Reg] -force
  assign_bd_address -offset 0x42000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S00_AXI_0] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces S00_AXI_1] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
...
set_property REGISTERED_WITH_MANAGER "1" [get_files reconfig_base_inst.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files reconfig_base_inst.bd ] 

#call make_wrapper to create wrapper files
set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse reconfig_base_inst.bd] -top]
