...
################################################################
# This is a generated script based on design: reconfig_base_inst
#
...
# ------------------------------------------------------------------
set hls_ip_repo [file normalize [file join $script_folder hls/export]]

if {![file exists $hls_ip_repo]} {
    error "HLS IP repository not found: $hls_ip_repo"
}
...
xilinx.com:hls:ddr_scale_accel:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_ctrl, and set properties
  set axi_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 axi_ctrl ]
  set_property -dict [list \
    CONFIG.NUM_MI {1} \
    CONFIG.NUM_SI {1} \
  ] $axi_ctrl
  ...
  set axi_data [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 axi_data ]
  set_property -dict [list \
    CONFIG.NUM_CLKS {1} \
    CONFIG.NUM_MI {1} \
    CONFIG.NUM_SI {1} \
  ...
  # Create instance: axi_mdata, and set properties
  ...
  # Create instance: ddr_scale_accel_0, and set properties
  set ddr_scale_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ddr_scale_accel:1.0 ddr_scale_accel_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_0_1 [get_bd_intf_ports S00_AXI_0] [get_bd_intf_pins axi_ctrl/S00_AXI]
  connect_bd_intf_net -intf_net S00_AXI_1_1 [get_bd_intf_ports S00_AXI_1] [get_bd_intf_pins axi_data/S00_AXI]
  connect_bd_intf_net -intf_net axi_a3data_M00_AXI [get_bd_intf_pins axi_data/M00_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ctrl_M00_AXI [get_bd_intf_pins ddr_scale_accel_0/s_axi_control] [get_bd_intf_pins axi_ctrl/M00_AXI]
  connect_bd_intf_net -intf_net ddr_scale_accel_0_m_axi_gmem [get_bd_intf_pins axi_mdata/S00_AXI] [get_bd_intf_pins ddr_scale_accel_0/m_axi_gmem]
  ...
  [get_bd_pins ddr_scale_accel_0/ap_clk]
  connect_bd_net -net ddr_scale_accel_0_interrupt  [get_bd_pins ddr_scale_accel_0/interrupt] \
  ...
  [get_bd_pins ddr_scale_accel_0/ap_rst_n]
  connect_bd_net -net xlconcat_0_dout  [get_bd_pins xlconcat_0/dout] \
  [get_bd_ports interrupt]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces ddr_scale_accel_0/Data_m_axi_gmem] [get_bd_addr_segs M00_AXI_0/Reg] -force
  assign_bd_address -offset 0x42000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S00_AXI_0] [get_bd_addr_segs ddr_scale_accel_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S00_AXI_1] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
